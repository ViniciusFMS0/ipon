...
const App = () => {
  ...
  useEffect(() => {
    ...
    const handleClick = (event) => {
      if (!event.target.closest(".unit-switch")) {
            ...
            <div className="nav-actions">
              <div className="unit-switch">
                ...
                >
                  ...
                  <span className={`unit-chevron ${unitMenuOpen ? "open" : ""}`}>▾</span>
                </motion.button>
                <AnimatePresence>
                  {unitMenuOpen && (
                    <motion.div
                    ...
                    >
                      {Object.values(units).map((unit) => (
                        ...
                        >
                          <span className="option-title">{unit.name}</span>
                          <span className="option-sub">{unit.sub}</span>
                        </button>
                      ))}
                    </motion.div>
                  )}
